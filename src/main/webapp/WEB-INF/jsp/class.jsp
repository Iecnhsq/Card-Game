        ...
        <div>
            <c:if test="${HU}">
                ...
                <p style="text-align: center">
                    <img src="src/img/cardback.png" style="border: 2px solid #aad372; border-radius: 15px"/>
                </p>
                <a href="card.html">Back to select a deck</a>
            </c:if> 
            <c:if test="${MA}">
                ...
                <p style="text-align: center">
                    <img src="src/img/cardback.png" style="border: 2px solid #68ccef; border-radius: 15px"/>
                </p>
                <a href="card.html">Back to select a deck</a>
            </c:if> 
            <c:if test="${PR}">
                ...
                <p style="text-align: center">
                    <img src="src/img/cardback.png" style="border: 2px solid #fff; border-radius: 15px"/>
                </p>
                <a href="card.html">Back to select a deck</a>
            </c:if>
            <c:if test="${RO}">
                ...
                <p style="text-align: center">
                    <img src="src/img/cardback.png" style="border: 2px solid #fff468; border-radius: 15px"/>
                </p>
                <a href="card.html">Back to select a deck</a>
            </c:if>
            <c:if test="${SH}">
                ...
                <p style="text-align: center">
                    <img src="src/img/cardback.png" style="border: 2px solid #2359ff; border-radius: 15px"/>
                </p>
                <a href="card.html">Back to select a deck</a>
            </c:if>
            <c:if test="${WR}">
                ...
                <p style="text-align: center">
                    <img src="src/img/cardback.png" style="border: 2px solid #c69b6d; border-radius: 15px"/>
                </p>
                <a href="card.html">Back to select a deck</a>
            </c:if>
        </div>
